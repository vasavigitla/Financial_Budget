...
import org.launchcode.Financial_Budget.models.data.dto.LoginFormDTO;
import org.launchcode.Financial_Budget.models.data.dto.RegisterFormDTO;
...
public class AuthenticationController {
    ...
    @PostMapping("/register")                  //add @Valid to modelattribute
    ...
    @PostMapping("/login")                        //add valid to model attribute
